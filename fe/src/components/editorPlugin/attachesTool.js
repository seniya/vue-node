import './attachesTool.css'
import Uploader from './attachesToolUploader'
import Icon from './attachesToolSvg/toolbox.svg'
import FileIcon from './attachesToolSvg/standard.svg'
import CustomFileIcon from './attachesToolSvg/custom.svg'
import DownloadIcon from './attachesToolSvg/arrow-download.svg'
...
export default class AttachesTool {
  ...
  onUpload (response) {
    ...
    console.log('onUpload body.success : ', body.success)
    console.log('onUpload body.file : ', body.file)
    ...
    if (body.success && body.file) {
      ...
      console.log('onUpload errorMessage : ', this.config.errorMessage)
