...
require('./codeBlock.css').toString()
...
export default class CodeTool {
  ...
  drawView () {
    this.nodes.textarea.hidden = false
    this.nodes.btnHighlight.hidden = false
    this.nodes.selectList.hidden = false

    const highlight = document.getElementById('pre-highlight')
    const btn = document.getElementById('btn-highlight')
    highlight.remove()
    btn.remove()

    this.nodes.highlight = undefined
    this.nodes.bntEdit = undefined
  }

  drawHighlight () {
    const textVaule = this.nodes.textarea.value
    ...
    this.nodes.textarea.hidden = true
    this.nodes.btnHighlight.hidden = true
  ...
  /* TO-DO */
  drawReadonly () {
    // console.log('drawReadonly : ', this.data.highlight)
    // const pre = document.createElement('pre')
    // pre.innerHTML = this.data.highlight
  ...
  render () {
    ...
    const selectList = this.langSelect()
    selectList.value = this.data.lang
    ...
    this.nodes.btnHighlight = button
    this.nodes.selectList = selectList
  ...
  langSelect () {
    const array = ['plaintext', 'html', 'javascript', 'json', 'powershell', 'shell', 'sql', 'css', 'scss']
