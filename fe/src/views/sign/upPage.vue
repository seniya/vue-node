        ...
        <div id="formContent">
          ...
          <v-spacer class="mt-5"></v-spacer>
            <form>
              ...
              <input type="password" class="fadeIn second" v-model="formUp.pwd"  placeholder="password" disabled>
              ...
              <v-container>
                <v-row>
                  <v-col cols="12" sm="12" md="12" lg="12">
                      <uselessCheckbox style="float: left;" @change="changeConfirm" />
                      <div style="float: left; height: 200px; padding-top:110px">
                        회원가입을<br /> 진행 하시겠습니까?
                      </div>
                  </v-col>
                </v-row>
              </v-container>
              <input type="button" class="fadeIn fourth" value="SIGN UP" :disabled="formUp.confirm" @click="checkRobot()">
            </form>
          </template>
...
import uselessCheckbox from '@/components/uselessCheckbox.vue'
  ...
  methods: {
    async submitSignUp () {
      try {
        ...
        console.log('submitSignUp data : ', data)
    ...
    changeConfirm (v) {
      console.log('changeConfirm : ', v)
      this.formUp.confirm = !v
    },
    changeType (nType) {
