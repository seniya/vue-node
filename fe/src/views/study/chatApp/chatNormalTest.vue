script<template>
  <div>Test
    <div>
      <v-btn @click="demo1">Demo1</v-btn>
    </div>
    <v-divider></v-divider>
    <div>
      <v-btn @click="demo2">Demo2</v-btn>
    </div>
    <v-divider></v-divider>
    <div>
      <v-btn @click="demo3">Demo3</v-btn>
    </div>
    <v-divider></v-divider>
    <div>
      <v-btn @click="demo4">Demo4</v-btn>
    </div>
    <v-divider></v-divider>
    <div>
      <v-btn @click="demo5">Demo5</v-btn>
    </div>
    <v-divider></v-divider>
    <div>
      <v-btn @click="demo6">Demo6</v-btn>
    </div>
    <v-divider></v-divider>
    <div>
      <v-btn @click="demo7">Demo7</v-btn>
    </div>
    <v-divider></v-divider>
    <div>
      <v-btn @click="demo8">demo8</v-btn>
    </div>
    <v-divider></v-divider>
    <div>
      <v-btn @click="demo9">demo9</v-btn>
    </div>
    <v-divider></v-divider>
    <div>
      <v-btn @click="demo10">demo10</v-btn>
    </div>
    <v-divider></v-divider>
    <div>
      <v-btn @click="demo11">demo11</v-btn>
    </div>
    <v-divider></v-divider>
    <div>
      <v-btn @click="demo12">demo12</v-btn>
    </div>
    <v-divider></v-divider>
    <div>
      <v-btn @click="demo13">demo13</v-btn>
    </div>
    <v-divider></v-divider>
    <div>
      <v-btn @click="demo14">demo14</v-btn>
    </div>
    <v-divider></v-divider>
    <div>
      <v-btn @click="demo15">demo15</v-btn>
    </div>
    <v-divider></v-divider>
    <div>
      <v-btn @click="demo16">demo16</v-btn>
    </div>
    <v-divider></v-divider>
    <div>
      <v-btn @click="demo17">demo17</v-btn>
    </div>
...
export default {
  methods: {
    ...
    async demo5 () {
      const db2 = await openDB('db2', 1)
      // retrieve by key:
      await db2.get('store3', 'cat001').then(console.log)
      // retrieve all:
      await db2.getAll('store3').then(console.log)
      // count the total number of items in a store:
      await db2.count('store3').then(console.log)
      // get all keys:
      await db2.getAllKeys('store3').then(console.log)
      db2.close()
    },
    ...
    async demo13 () {
      ...
      const strongestCats = await strengthIndex.getAll(10)
      console.log('strongest cats: ', strongestCats)
      // get the first entry where the key is 10:
      const oneStrongCat = await strengthIndex.get(10)
    ...
    async demo14 () {
      ...
      const weakestCats = await db3.getAllFromIndex('moreCats', 'strengthIndex', 1)
      console.log('weakest cats: ', weakestCats)
      const oneWeakCat = await db3.getFromIndex('moreCats', 'strengthIndex', 2)
