    ...
    <v-container>
      ...
      <v-row class="page-row">
        <v-col cols="12" class="page-content">
          <v-card class="card">
            <div class="content">
              <h2 class="title">진행자</h2>
              <p class="copy">Player-1</p>
              <v-btn text color="white" v-if="enableCheckIn('player-1')" @click="actionCheck('player-1')">
                <v-icon left color="white">mdi-location-enter</v-icon>
                입장
              </v-btn>
              <v-btn text color="white" v-else disabled >
          ...
          <v-card class="card">
            <div class="content">
              <h2 class="title">참가자</h2>
              <p class="copy">Player-2</p>
              <v-btn text color="white" v-if="enableCheckIn('player-2')" @click="actionCheck('player-2')">
                <v-icon left color="white">mdi-location-enter</v-icon>
                입장
              </v-btn>
              <v-btn text color="white" v-else disabled >
          ...
          <v-card class="card">
            <div class="content">
              <h2 class="title">참가자</h2>
              <p class="copy">Player-3</p>
              <v-btn text color="white" v-if="enableCheckIn('player-3')" @click="actionCheck('player-3')">
                <v-icon left color="white">mdi-location-enter</v-icon>
                입장
              </v-btn>
              <v-btn text color="white" v-else disabled >
          ...
          <v-card class="card">
            <div class="content">
              <h2 class="title">참가자</h2>
              <p class="copy">Player-4</p>
              <v-btn text color="white" v-if="enableCheckIn('player-4')" @click="actionCheck('player-4')">
                <v-icon left color="white">mdi-location-enter</v-icon>
                입장
              </v-btn>
              <v-btn text color="white" v-else disabled >
